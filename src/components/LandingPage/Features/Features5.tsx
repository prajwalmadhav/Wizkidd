...
export default function Fg()  {
  const Feature = (props: { icon: boolean | ReactChild | ReactFragment | ReactPortal | null | undefined; title: boolean | ReactChild | ReactFragment | ReactPortal | null | undefined; children: boolean | ReactChild | ReactFragment | ReactPortal | null | undefined; }) => {
    return (
      <Box >
        <Icon
          boxSize={12}
